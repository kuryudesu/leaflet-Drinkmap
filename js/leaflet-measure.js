!function(e) {
  ...
  , function(e, t, r) {
    e.exports = '<a class="{{ model.className }}-toggle js-toggle" href=# title="測量距離和面積">Measure</a> <div class="{{ model.className }}-interaction js-interaction"> <div class="js-startprompt startprompt"> <h3>測量距離和面積</h3> <ul class=tasks> <a href=# class="js-start start">創建新測量</a> </ul> </div> <div class=js-measuringprompt> <h3>測量距離和面積</h3> <p class=js-starthelp>通過向地圖添加點開始創建測量</p> <div class="js-results results"></div> <ul class="js-measuretasks tasks"> <li><a href=# class="js-cancel cancel">取消</a></li> <li><a href=# class="js-finish finish">完成測量</a></li> </ul> </div> </div> '
  }
  , function(e, t, r) {
    e.exports = '<div class=group> <p class="lastpoint heading">最後一點</p> <p>{{ model.lastCoord.dms.y }} <span class=coorddivider>/</span> {{ model.lastCoord.dms.x }}</p> <p>{{ numberFormat(model.lastCoord.dd.y, 6) }} <span class=coorddivider>/</span> {{ numberFormat(model.lastCoord.dd.x, 6) }}</p> </div> <% if (model.pointCount > 1) { %> <div class=group> <p><span class=heading>路徑距離</span> {{ model.lengthDisplay }}</p> </div> <% } %> <% if (model.pointCount > 2) { %> <div class=group> <p><span class=heading>面積</span> {{ model.areaDisplay }}</p> </div> <% } %> '
  }
  , function(e, t, r) {
  ...
  , function(e, t, r) {
    e.exports = '<h3>面積測量</h3> <p>{{ model.areaDisplay }}</p> <p>{{ model.lengthDisplay }} 周長</p> <ul class=tasks> <li><a href=# class="js-zoomto zoomto">區域中心</a></li> <li><a href=# class="js-deletemarkup deletemarkup">刪除</a></li> </ul> '
  }
]);
